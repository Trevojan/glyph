...
| **O app de navegador existe: é o MVP** | *"o app de navegador deve existir porque é um MVP. ainda assim, há o que ser feito em Rust."* O núcleo WASM deixa de ser opcional (M11b) |
