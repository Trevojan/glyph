...
| EMS-001 | fechadas: `ORD-0001`, o oráculo congelado, em `030ed76`, a tag `conformance-v0`, digest `c00119e0…d828`; `ORD-0002`, `glyph-util` e `glyph-version`, em `79aebbd`, digest `6fb833ec…7b5c`; `ORD-0003`, `glyph-vocab` e `glyph-stores`, em `d9ea4fe`, digests `55ba73da…bf25` e `4f03181d…d4b1`. `ORD-0004`, `glyph-lex`, em `06989f7`, digests `c00119e0…d828` e `b70bb078…01b8`. `ORD-0005`, `glyph-logic`, em `12cc408`, digests `c00119e0…d828` e `53ec4964…b546`. `ORD-0006`, `glyph-templates` e `glyph-rules`, em `ca9c1a6`, digests `c00119e0…d828` e `cb065d27…1ed3`. `ORD-0007`, `glyph-parse`, em `1a79b2c`, digests `c00119e0…d828` e `3fd68d65…ef9b`. `ORD-0008`, `glyph-xml` e o binário `glyph`, em `97ea472`, digests `c00119e0…d828` e `cfab5a59…2c63`. `ORD-0009`, `glyph-envelope`, `glyph-burn` e `glyph-inverse`, em `9c943d3`, digests `c00119e0…d828` e `3ae341cc…c326` (`inverse.json`). `ORD-0010`, o protocolo B, em `7eab706`, digests `c00119e0…d828` e `6cbc1de1…9042` (`protocol.json`). `ORD-0011`, o app no motor Rust atrás de `engine=relay`, em `cf3bb31`, digests `c00119e0…d828` e `e95a54e5…1e78` (`protocol.json`). Próxima: `ORD-0012`, a CLI Rust com as flags do `glyph-cli.js`; a retomada local está em [`HANDOFF-2026-09-26.pgml`](../.orders/HANDOFF-2026-09-26.pgml). Primeiro do plano: os caminhos virtuais ([`.plan`](../.plan/README.md) §0). O registro é o [README da série](../.orders/EMS-001/README.md) |
