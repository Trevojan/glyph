...
| EMS-001 | fechadas: `ORD-0001`, o oráculo congelado, em `030ed76`, a tag `conformance-v0`, digest `c00119e0…d828`; `ORD-0002`, `glyph-util` e `glyph-version`, em `79aebbd`, digest `6fb833ec…7b5c`. Aberta: nenhuma; a próxima é a `ORD-0003`. O registro é o [README da série](../.orders/EMS-001/README.md) |
