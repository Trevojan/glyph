...
(function (root) {
  ...
  "schema": 2,
  "note": "GENERATED by build-templates.js from expansoes.txt (composition) and GLOSSARY.md (definitions) — DO NOT EDIT BY HAND. Every command carries `species` (`atom` = a hieroglyph, does not decompose; `composite` = a glyph, with the `formula` that decomposes it), `depth` (0 for an atom, 1 + the deepest dependency otherwise) and `def`, what the command means. `def` is the only thing an atom has to say about itself.",
  "atoms": 88,
  "composites": 32,
  "maxDepth": 6,
  "commands": {
