---
name: glyph-markup
description: Glyph Shorthand Markup Language v3.4.7.05 Specification & Parser Integration. Use when writing or reading Glyph compact structured notation.
---

# Glyph Shorthand Markup Language (v3.4.7.05)
...
| `XmlLegacyRoot` | `<glyph>` as the root, the shape through 2.4.4 | re-emit the document with 3.4.7.05 |
