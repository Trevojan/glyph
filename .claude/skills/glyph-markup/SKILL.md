---
name: glyph-markup
description: Glyph Shorthand Markup Language v3.5.8.06 Specification & Parser Integration. Use when writing or reading Glyph compact structured notation.
---

# Glyph Shorthand Markup Language (v3.5.8.06)
...
| `XmlLegacyRoot` | `<glyph>` as the root, the shape through 2.4.4 | re-emit the document with 3.5.8.06 |
